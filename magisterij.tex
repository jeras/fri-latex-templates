...
Robne uteži izračunane za zadnjo vrstico predstavljajo število sseh predslik.
...
\begin{figure}[htb]
\centerline{\psfig{figure=network_algorithm_issue,width=14cm}}
\caption[Mreža polja celic.]{Mreža velikosti \(N_x=3\) in \(N_y=3\) za binarni CA z okolico quad.}
\label{network_algorithm_issue}
\end{figure}
