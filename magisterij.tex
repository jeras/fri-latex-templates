...
\begin{figure}[htb]
\centerline{\psfig{figure=neighborhood_index_isometric,width=8cm}}
...
\begin{figure}[htb]
\centerline{\psfig{figure=overlap_dimension_isometric,width=8cm}}
\caption[Prekrivaje okolic.]{Prekrivanje okolic sosednjih celic v smeri dimenzij X in Y.}
\label{overlap_dimension}
\end{figure}

\begin{figure}[htb]
\centerline{\psfig{figure=overlap_diagonal_isometric,width=8cm}}
