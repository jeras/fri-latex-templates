...
Celični avtomat razdeli na vrstice in išče predlike za posamezno vrstico od prve do zadnje.
...
It is possible to determine if a 1D cellular automaton is reversible,
...
Row results are then combined into a result for the whole 2D problem.
...
while raws are also observed from the opposite side.
