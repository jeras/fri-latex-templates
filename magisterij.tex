...
S stališča algoritma za štetje predslik je GoE stanje tako stanje, ki nima nobene predslike.
...
V primeru, če so robovi polja ciklično zaprti (polje v obliki torusa),
...
in njegova skupina uporabljajo za analizo te De Bruijnove grafe neposredno. Sam sem pa
...
De Bruijnovega grafa dodana nova dimenzija. Povezave med vozliči se spremenijo
...
oziroma če je sploh obravnavana.
...
Obstaja še en enostaven robni pogoj, ki je definiran za ciklično sklenjena končna CA polja.
...
V koraku \textbf{2} pri procesiranju vrstice (sliki \ref{algorithm_line})
...
Optimizirani so le za GoE stanja, kjer je predslik malo tudi za samo del GoE konfiguracije.
