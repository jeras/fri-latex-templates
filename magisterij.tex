...
V prvem koraku začetno vozlišče dobi utež \(w(začetek)=1\).
...
Poudarjen blok [X] v algoritmu za dimenzijo X je podoben algoritem (slika \ref{algoritm_count-y}), ki pa 
ne definira nabora predslik vrstice,
potrebno ga je izračunati za vsako vrstico posebej.

\begin{figure}[htb]
\centerline{\psfig{figure=algorithm_count-y,width=16cm}}
