...
posledično pripada povezan niz mrež predslik (slika \ref{algorithm_line} mreža 1).
...
Vsaka pot je obravnavana posebej (slika \ref{algorithm_line} mreža 2, odebeljena pot).
...
pregod iz mreže 1 v mrežo 2). Za tem korakom, so vse ploskve definirane
...
prehod iz mreže 2 v mrežo 3). To je problem, ekvivalenten iskanju predslik
(zvenih poti v grafu) za 1D CA, za kar se uporabi algoritem opisan v \cite{}.
Rezultat so poti na prerezu med ploskvami (slika \ref{algorithm_line} mreža 4,
