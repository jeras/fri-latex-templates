...
Za sedaj še odprta možnost za obstoj algoritma z kompleksnstjo
...
Štarta se z znanim številom predslik, ki ga je dalo štetje in se
...
Vsaki celici v nizu pripada lastna mreža predslik, eno dimenzinalnemu nizu celic
posledično pripada povezan niz mrež predslik (slika \ref{}).
...
Na začetku se ploskve okolic sosednjih celic še ne povezijejo v
zvezno ploskev čez celoten niz. Izločiti je potrebno vse ploskve okolic,
ki se ne povezijejo s okolicami svojih sosednjih celic.

Ker se vsaka vrstica povezuje s predhodnjo in naslednjo vrstico, je potrebno
...
Začetni robni pogoj za vsako vrstico je nabor poti med vozlišči na začetni vrstice.
Vsaka pot je obravnavana posebej.

Začetni robni pogoj se aplicira tako, da se izloči iz obravnave vse ploskve,
ki nimajo skupnega roba z robno potjo. Za tem korakom, so vse ploskve definirane
...
dvo dimenzionalno mrežo, kjer se procesirajo poti med vozlišči.
To je problem, ekvivalenten iskanju predslik (zvenih poti v grafu) za 1D CA.
...
Če procesiranje poteka v smeri dimenzij X in Y potem je robni pogoj definiran
na strani, kjer se procesiranje začne (slika \ref{}).
...
Podan je primer, ki kaže zakaj procesiraje z linearno kompleksnostjo ni mogoče.
