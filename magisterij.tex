...
\vspace{0.5cm}
\noindent
cellular automata, preimages, ataviser, computational complexity, reversibility, Garden of Eden, Game of Life, trid, quad
...
pregod iz mreže \textbf{1} v mrežo \textbf{2}). Za tem korakom, so vse ploskve definirane
...
Torej po prejčnih korakih še ni točno določeno, katere ploskve se združujejo v zvezno
celoto in katere ne.
...
ali na splošno bi bilo število obravnav manjhna konstanta (4 krat,
...
vozlišča. Najberž obstajajo tudi druge optimizacije algoritma, ki lahko zmanjšajo
