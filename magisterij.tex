...
tako da se operacije nad celimi števili pretvori v logične operacije nad Boolovimi staji.
...
od dimenzij CA mreže  \( O(2^2N) \), ja pa možno da obstaja algoritem z nižjo kompleksnostjo.
...
bolj splošne definicije, kjer je za vsako celico definiran lasten nabor predslik,
...
Če je 1D CA definiran kakor daljica je robni pogoj samo eden.
