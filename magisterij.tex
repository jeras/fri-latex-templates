...
\begin{figure}[htb]
\centerline{\psfig{figure=overlap_dimension,width=8cm}}
...
\begin{figure}[htb]
\centerline{\psfig{figure=overlap_diagonal,width=8cm}}
...
\textbf{Prvi element:}
Iz definicije velja, da je za eno samo celico v mreži nabor ploskev
enak naboru vseh predslik.
