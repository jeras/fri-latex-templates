...
\end{enumerate}
Algoritme za reševanje SAT problemov poznam bolj slabo,
...
\textbf{Presek} 2D mreže predslik \(P_x(x)\) je nabor zveznih poti \(e\) na koordinati \(x\).
S stališča polja celic, je to nabor vseh možnih prekrivanj ploskev 
...
\begin{figure}[htb]
\centerline{\psfig{figure=algorithm_count-y,width=14cm}}
\caption[Algoritem.]{Algoritem.}
\label{algoritm}
\end{figure}

\subsection{Procesiranje v eni dimenziji}
...
\subsection{Procesiranje v drugi dimenziji}
